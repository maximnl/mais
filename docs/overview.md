...
?>Data warehouses provide a powerful centralized solution for reporting, 
?>but the main benefits are lost if additional data is required or data definitions 
?>do not match business definitions.
