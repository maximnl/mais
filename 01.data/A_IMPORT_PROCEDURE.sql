...
CREATE TABLE [A_IMPORT_PROCEDURE](
...
ALTER TABLE [A_IMPORT_PROCEDURE] ADD  CONSTRAINT [DF_A_IMPORT_PROCEDURE_procedure_guid]  DEFAULT (newid()) FOR [procedure_guid]
GO

ALTER TABLE [A_IMPORT_PROCEDURE] ADD  CONSTRAINT [DF_A_IMPORT_PROCEDURE_active_1]  DEFAULT ((1)) FOR [active]
GO

ALTER TABLE [A_IMPORT_PROCEDURE] ADD  CONSTRAINT [DF_A_IMPORT_PROCEDURE_date_updated_1]  DEFAULT (getdate()) FOR [date_updated]
GO

ALTER TABLE [A_IMPORT_PROCEDURE] ADD  CONSTRAINT [DF_A_IMPORT_PROCEDURE_date_created_1]  DEFAULT (getdate()) FOR [date_created]
GO
