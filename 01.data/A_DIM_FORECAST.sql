...
ALTER TABLE [A_DIM_FORECAST] ADD  CONSTRAINT [DF_A_DIM_FORECAST_forecast_guid]  DEFAULT (newid()) FOR [forecast_guid]
GO

ALTER TABLE [A_DIM_FORECAST] ADD  CONSTRAINT [DF_A_DIM_FORECAST_active]  DEFAULT ((1)) FOR [active]
GO
