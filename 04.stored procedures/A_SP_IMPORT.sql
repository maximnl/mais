...
   	BEGIN
        ...
        IF @source='' or @source like 'A_%' or @source like '[A_%' BEGIN
...
   			SET @data=JSON_MODIFY( @data,'$.error',dbo.[A_FN_SYS_ErrorJson]()); 
	...
	IF @commands  like '%-INTRADAY%' AND @commands not like '%-NOINTRADAY%' BEGIN  
        ...
        IF @source='' or @source like '%A_FACT_INTRADAY%' SET @intraday_source=@fact_intraday;
        ELSE SET @intraday_source=@source + ' ' + @intraday_join;
