...
/****** Object:  StoredProcedure [A_SP_IMPORT]    Script Date: 26-7-2022 11:34:44 ******/
SET ANSI_NULLS OFF
GO
...
,@commands varchar(2000)='' -- '-PRINT -LOG_ROWCOUNT -LOG_INSERT -LOG_DELETE -NOGROUPBY -SUMFIELDS -NOINTRADAY -NODELTA -INTRADAY -VERSION -HELP ; see HELP for docs
...
   	END -- END OF FETCHING IMPORTS
	...
	IF @commands like '%-PRINT%' and @commands like '%-VERSION%' PRINT @version 
	...
	IF @commands like '%-PRINT%' and @commands like '%-HELP%' PRINT @help 
